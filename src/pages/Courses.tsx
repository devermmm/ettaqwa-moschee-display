              ...
              <div className="grid md:grid-cols-2 gap-8 p-8">
                <div className="flex items-center justify-center">
                  <img
                    ...
                    className="max-w-sm w-full h-auto object-cover rounded-lg shadow-md"
                  />
                </div>
                <div className="flex flex-col justify-center space-y-4">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    <p className="text-lg leading-relaxed">
                      {language === "bs"
                        ? "Počinje nova školska godina mekteba! Prijavite svoju djecu za kvalitetno islamsko obrazovanje gdje će naučiti osnove vjere, arapski jezik i pravilno učenje Kur'ana."
                        : "Das neue Mekteb-Schuljahr beginnt! Melden Sie Ihre Kinder für eine hochwertige islamische Bildung an, wo sie die Grundlagen des Glaubens, Arabisch und das korrekte Lernen des Qurans erlernen."}
                    </p>
              ...
              <div className="grid md:grid-cols-2 gap-8 p-8">
                <div className="flex flex-col justify-center space-y-4 order-2 md:order-1">
                  ...
                  <div className="space-y-3 text-muted-foreground">
                    <p className="text-lg leading-relaxed">
                      {language === "bs"
                        ? "Naša kur'anska škola nudi sveobuhvatan program učenja Kur'ana sa iskusnim i kvalificiranim učiteljima. Fokusiramo se na pravilnu recitaciju, učenje tedžvida i razumijevanje značenja ajeta."
                        : "Unsere Quran-Schule bietet ein umfassendes Programm zum Lernen des Qurans mit erfahrenen und qualifizierten Lehrern. Wir konzentrieren uns auf korrekte Rezitation, Tajweed-Lernen und das Verständnis der Bedeutung der Verse."}
                    </p>
                    <div className="space-y-2">
                      <p className="font-semibold text-foreground flex items-center gap-2">
                        <span>📖</span>
