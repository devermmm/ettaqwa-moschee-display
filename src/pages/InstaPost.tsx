...
const InstaPost = () => {
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      const scaleFactor = 1080 / currentWidth;
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 gap-6">
      ...
      <Button onClick={handleDownload} size="lg" className="gap-2" disabled={downloading}>
        ...
        {downloading ? "Wird erstellt..." : "Als PNG herunterladen (1080×1080)"}
      </Button>

      <p className="text-sm text-muted-foreground max-w-md text-center">
        Das Bild wird in voller Instagram-Auflösung (1080×1080px) heruntergeladen.
      </p>
    </div>
  );
};
