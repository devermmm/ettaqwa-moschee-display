...
const Projects = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-background via-background/95 to-muted/50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 pt-16 sm:pt-24 md:pt-32 pb-12 sm:pb-20 relative">
        <motion.div
        ...
        >
          ...
          <div className="text-center mb-12 sm:mb-20">
            <motion.h1 
              ...
              className="text-3xl sm:text-5xl md:text-7xl font-bold mb-4 sm:mb-6 bg-gradient-to-r from-primary via-accent to-primary bg-clip-text text-transparent"
            >
              {t("projects.title")}
            </motion.h1>
            <motion.div
              ...
              className="h-1.5 w-32 sm:w-40 mx-auto bg-gradient-to-r from-primary via-accent to-primary rounded-full mb-6 sm:mb-8 shadow-lg shadow-primary/20"
            />
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="text-base sm:text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed px-4"
            >
              {t("projects.subtitle")}
            </motion.p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-20">
            {projects.map((project, index) => {
              ...
              return (
                ...
                >
                  <div className="relative bg-card/60 backdrop-blur-sm rounded-3xl p-6 sm:p-8 shadow-xl border border-border/50 hover:shadow-2xl transition-all duration-500 hover:-translate-y-3 h-full">
                    {/* Icon with gradient background */}
                    <div className="relative mb-4 sm:mb-6">
                      <div className={`inline-flex p-4 sm:p-5 rounded-2xl bg-gradient-to-br ${project.color} shadow-xl group-hover:scale-110 transition-transform duration-300`}>
          ...
          <motion.div
            ...
            className="relative bg-gradient-to-br from-primary/10 via-accent/5 to-primary/10 backdrop-blur-sm rounded-3xl p-8 sm:p-12 md:p-16 text-center shadow-2xl border border-primary/20 overflow-hidden"
          >
            {/* Decorative circles */}
            <div className="absolute -top-10 -right-10 w-32 h-32 sm:w-40 sm:h-40 bg-primary/10 rounded-full blur-2xl" />
            <div className="absolute -bottom-10 -left-10 w-32 h-32 sm:w-40 sm:h-40 bg-accent/10 rounded-full blur-2xl" />
            ...
            <div className="relative">
              ...
              <a
                ...
                className="inline-flex items-center gap-2 sm:gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-primary to-accent text-white rounded-xl font-semibold text-base sm:text-lg shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
              >
