...
const TikTokOverlay = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-900 flex flex-col items-center justify-center gap-6 p-4">
      <h1 className="text-white text-xl font-bold">TikTok Overlay – 9:16</h1>

      {/* Preview container (9:16 scaled down) */}
            ...
            >
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
                  ...
                  <span style={{ color: "white", fontSize: 38, fontWeight: 700, fontFamily: "system-ui, sans-serif", textShadow: "0 2px 12px rgba(0,0,0,0.8)" }}>
                    @dzemat_et_taqwa
                  </span>
                </div>
                <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
      ...
      <p className="text-white/40 text-xs">1080×1920 · 9:16 · Transparenter Hintergrund</p>
    </div>
  );
};
