      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* ===== HEADER ===== */}
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "5px", flexShrink: 0 }}>
              <img src={logo} alt="Et-Taqwa" style={{ height: "52px", width: "52px", flexShrink: 0, borderRadius: "4px" }} />
              <div style={{ textAlign: "center", flex: 1 }}>
                <p style={{ fontSize: "17px", fontWeight: "bold", color: "#1f2937", fontFamily: "'Amiri', 'Traditional Arabic', serif", direction: "rtl", lineHeight: 1.3, margin: 0 }}>
                  ذَهَبَ الظَّمَأُ وَابْتَلَّتِ العُرُوقُ وَثَبَتَ الأَجْرُ إِنْ شَاءَ اللّٰهُ
                </p>
                <p style={{ fontSize: "8.5px", color: "#4b5563", fontStyle: "italic", margin: "2px 0 0 0" }}>
                  Zehebez-zameu vebtelletil-'uruku ve sebetel-edžru inšaAllah.
                </p>
                <p style={{ fontSize: "7.5px", color: "#6b7280", margin: "1px 0 0 0" }}>
            ...
            <div style={{ textAlign: "center", marginBottom: "5px", flexShrink: 0 }}>
              <h1 style={{ fontSize: "24px", fontWeight: 900, color: "#065f46", letterSpacing: "4px", lineHeight: 1, margin: 0 }}>VAKTIJA</h1>
              <p style={{ fontSize: "10px", color: "#374151", fontWeight: 600, margin: "3px 0 0 0" }}>RAMAZAN 2026 / 1447. h. &nbsp;(19. februar – 19. mart)</p>
            </div>

            {/* ===== TABLE ===== */}
            <div style={{ flex: 1, overflow: "hidden", display: "flex", flexDirection: "column" }}>
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "11px", flex: 1, tableLayout: "fixed" }}>
                <thead>
                  <tr style={{ backgroundColor: "#065f46", color: "white", fontSize: "8.5px" }}>
                  ...
                  {ramadanDays.map((day) => {
                    ...
                    return (
                      <tr key={day.ramazanDay} style={{ backgroundColor: bg }}>
                        ...
                        <td style={{ border: "1px solid #d1d5db", textAlign: "left", paddingLeft: "5px", fontSize: "9px", color: event ? "#065f46" : "transparent", fontWeight: event ? 600 : 400, verticalAlign: "middle" }}>
                          {event || "–"}
                        </td>
            ...
            <div style={{ flexShrink: 0, marginTop: "4px" }}>
              ...
              <div style={{ textAlign: "center", backgroundColor: "#ecfdf5", border: "1.5px solid #6ee7b7", borderRadius: "4px", padding: "5px 8px" }}>
                <p style={{ fontSize: "11px", fontWeight: 700, color: "#064e3b", margin: 0, letterSpacing: "0.3px" }}>
                  Bajram namaz se klanja u petak 20. marta u 06:37 h
                </p>
              </div>

              {/* Sadaka */}
              <p style={{ fontSize: "7.5px", color: "#6b7280", textTransform: "uppercase", letterSpacing: "0.8px", fontWeight: 600, textAlign: "center", margin: "4px 0" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 2px", marginBottom: "4px" }}>
                <span style={{ fontSize: "26px", fontWeight: 900, color: "#065f46", lineHeight: 1 }}>2026.</span>
                <div style={{ textAlign: "center", flex: 1 }}>
                  <p style={{ fontSize: "10px", color: "#1f2937", fontWeight: 700, textTransform: "uppercase", margin: 0, letterSpacing: "0.5px" }}>Bosnischer Kulturverein Et-Taqwa</p>
                  <p style={{ fontSize: "8px", color: "#4b5563", margin: "2px 0 0 0" }}>Voitgasse 21, 1220 Wien &nbsp;•&nbsp; dzematettaqwa@gmail.com</p>
                </div>
                <span style={{ fontSize: "26px", fontWeight: 900, color: "#065f46", lineHeight: 1 }}>1447.</span>
              </div>
              ...
              <div style={{ borderTop: "2px solid #065f46", paddingTop: "5px" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "8px", textAlign: "center" }}>
                  <div>
                    <p style={{ fontSize: "8.5px", fontWeight: 700, color: "#064e3b", textTransform: "uppercase", margin: 0, lineHeight: 1.3 }}>Džemat El-Ihsan</p>
                    <p style={{ fontSize: "7.5px", color: "#374151", margin: "1px 0 0 0", lineHeight: 1.3 }}>Leopoldgasse 10, 1020 Wien</p>
                    <p style={{ fontSize: "7.5px", color: "#6b7280", margin: 0, lineHeight: 1.3 }}>Tel: 06431274A600</p>
                  </div>
                  <div>
                    <p style={{ fontSize: "8.5px", fontWeight: 700, color: "#064e3b", textTransform: "uppercase", margin: 0, lineHeight: 1.3 }}>Džemat El-Ihsan</p>
                    <p style={{ fontSize: "7.5px", color: "#374151", margin: "1px 0 0 0", lineHeight: 1.3 }}>Troststraße 77</p>
                    <p style={{ fontSize: "7.5px", color: "#6b7280", margin: 0, lineHeight: 1.3 }}>Tel: 06811040160</p>
                  </div>
                  <div>
                    <p style={{ fontSize: "8.5px", fontWeight: 700, color: "#064e3b", textTransform: "uppercase", margin: 0, lineHeight: 1.3 }}>Kulturni Centar</p>
                    <p style={{ fontSize: "7.5px", color: "#374151", margin: "1px 0 0 0", lineHeight: 1.3 }}>"Sandžačka Bosna"</p>
                    <p style={{ fontSize: "7.5px", color: "#374151", margin: 0, lineHeight: 1.3 }}>Schöpfgasse 44, 1210 Wien</p>
                  </div>
                  <div>
                    <p style={{ fontSize: "8.5px", fontWeight: 700, color: "#064e3b", textTransform: "uppercase", margin: 0, lineHeight: 1.3 }}>Džemat "Sandžak"</p>
                    <p style={{ fontSize: "7.5px", color: "#374151", margin: "1px 0 0 0", lineHeight: 1.3 }}>Triester Str. 1, 11000 Wien</p>
                  </div>
                </div>
              </div>
            </div>
